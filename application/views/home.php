...
<div class="main-content">
    <div class="page-content">
        <div class="container-fuild">
            <div class="slider">
                <div id="img">
                    <img src="<?php echo base_url("assets\images\R6.jpg");?>"/>
                </div>
            </div>
            <div class="aho">
...
var slides=['<?php echo base_url("assets/images/R.jpg");?>','<?php echo base_url("assets/images/R2.jpg");?>','<?php echo base_url("assets/images/R3.jpg");?>','<?php echo base_url("assets/images/R7.jpg");?>','<?php echo base_url("assets/images/R5.jpg");?>','<?php echo base_url("assets/images/R6.jpg");?>'];
var Start=0;
function slider(){

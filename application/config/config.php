...
|
*/
$config['base_url'] = 'http://localhost/Gaming_store/public';
...
$config['csrf_exclude_uris'] = array('pdf/download');
...
|
*/
$config['encryption_key'] = 'jksdjqo9874jhrejy4y2@fssss$fg2%$GFgkjgsyggi';
